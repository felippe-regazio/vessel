...
/**
 * This function receives a Vessel Class-Based Component and wrap it into
...
export async function defineAsCustomElement(Component: any, componentName: string, definedConfig?: ExposeConfig) {
  ...
  // ------------------ Wraps the "VesselComponent" onto a Native Web Element
  ...
  customElements.define(componentName, class extends HTMLElement {
    ...
    init() {
      ...
      this.renderVesselComponent();
      this.initialized = true;
      this.$component.mounted();
    }

    private renderVesselComponent() {
      ...
      return new Promise((resolve, reject) => {
        try {
          ...
          if (attr && attr.css) {
            ...
            this.style.setProperty(`--${prefix}-${propName}`, String(value || attr.initial || ''));
          }
