 ...
 * directly to the DOM. This function is exposed directly on the { VesselComponent } 
 * class on index.ts and its used by the TS (tsconfig) as JSX pragma. This file also
 * exposes the fragment function, which is used to generate a JSX fragment. To 
 * configure your TS to compile JSX using the Vessel pragma you must install this
 * library and add those lines on you "tsconfig.json":
 * 
 *  {
 *    "compilerOptions": {
 *       "jsx": "react",
 *       "jsxFactory": "VesselComponent.h",
 *       "jsxFragmentFactory": "VesselComponent.f"
 *    }
 *  }
 * 
 * After this, you must import the VesselComponent on your file, this will automatically enable
 ...
 * space and complexity. See the Vessel docs for further details.
 */
