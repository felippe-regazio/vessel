...
export const _render = (comp: any): any => {
  ...
  // Class Component
  if (comp && comp.component && comp.component.isVesselClass) return renderClassComponent(comp)

  // Class Component (Uninitialized)
  if (comp.isVesselClass) return renderClassComponent({ component: comp, props: {} })
  ...
  // function
  if (typeof comp === 'function' && !comp.isVesselClass) return _render(comp())
